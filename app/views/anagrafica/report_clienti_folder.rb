...
#      include Helpers::ODF::Report
      ...
      def ui
        ...
        logger.debug('initializing ReportClientiFolder...')
        xrc = Xrc.instance()
        # Anagrafica cliente
      ...
      def btn_ricerca_click(evt)
        ...
        begin
          ...
          self.result_set_lstrep_anagrafica = ctrl.report_clienti()
...
#        report.add_field :intestazione, ['Anagrafica Clienti', dati_azienda.denominazione].join(' ')
#
#      end
#
