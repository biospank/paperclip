...
module Views
  module Dialog
    class RigheFatturaPdcClientiDialog < Wx::Dialog
      ...
      def initialize(parent, righe_fattura_pdc)
        ...
        xrc = Xrc.instance()
        xrc.resource.load_dialog_subclass(self, parent, "RIGHE_FATTURA_PDC_CLIENTI_DLG")
        ...
        xrc.find('txt_detrazione', self, :extends => DecimalField)
...
#              calcola_scorporo_residuo()
      ...
      def pdc_compatibile?
        if configatron.bilancio.attivo
          if self.riga_fattura_pdc.pdc && self.riga_fattura_pdc.pdc.costo?
            res = Wx::message_box("Il piano dei conti selezionato non è un ricavo.\nVuoi forzare il dato?",
              'Avvertenza',
