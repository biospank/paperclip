  ...
  module Scadenzario
    module IncassoBilancioPanel
      ...
      def ui()
        ...
        logger.debug('initializing IncassoBilancioPanel...')
        xrc = Xrc.instance()
        # NotaSpese
      ...
      def reset_incasso_command_state()
        if incasso.new_record?
          disable_widgets [btn_elimina]
          enable_widgets [txt_codice, txt_descrizione, lku_pdc_dare,
            lku_pdc_avere, lku_nc_pdc_dare, lku_nc_pdc_avere]
        else
          if incasso.modificabile?
            enable_widgets [btn_elimina, txt_codice, txt_descrizione, lku_pdc_dare,
              lku_pdc_avere, lku_nc_pdc_dare, lku_nc_pdc_avere]
          else
            disable_widgets [btn_elimina, txt_codice, txt_descrizione, lku_pdc_dare,
              lku_pdc_avere, lku_nc_pdc_dare, lku_nc_pdc_avere]
          end
        end
