...
module Views
  module Scadenzario
    module ReportScadenzeFornitoriFolder
...
#      include Helpers::ODF::Report
      ...
      def ui
        ...
        logger.debug('initializing ReportScadenzeFornitoriFolder...')
        xrc = Xrc.instance()
      ...
      def btn_ricerca_click(evt)
        ...
        begin
          Wx::BusyCursor.busy() do
            ...
            self.result_set_lstrep_scadenze = ctrl.report_scadenze_fornitori()
...
#      def btn_stampa_click(evt)
#        Wx::BusyCursor.busy() do
#          template = Helpers::ScadenzarioHelper::ScadenzeFornitoriTemplatePath
#          generate(template)
#        end
#      end
#
...
#        report.add_field :intestazione, ["Report Scadenze Fatture Fornitori", (filtro.al.blank? ? '' : "al #{filtro.al.to_s(:italian_date)}")].join(' ')
#      end
#
