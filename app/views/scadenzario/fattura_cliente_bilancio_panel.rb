...
require 'app/views/scadenzario/incassi_fattura_cliente_bilancio_panel'
require 'app/views/scadenzario/fattura_cliente_common_actions'

module Views
  module Scadenzario
    module FatturaClienteBilancioPanel
      ...
      def ui(container=nil)
        ...
        logger.debug('initializing FatturaClienteBilancioPanel...')
        xrc = Xrc.instance()
        # Fattura cliente
        ...
        xrc.find('INCASSI_FATTURA_CLIENTE_BILANCIO_PANEL', container,
          :extends => Views::Scadenzario::IncassiFatturaClienteBilancioPanel,
          :force_parent => self,
          :alias => :incassi_fattura_cliente_panel) # importante mantenere l'alias per riutilizzare il modulo incluso
