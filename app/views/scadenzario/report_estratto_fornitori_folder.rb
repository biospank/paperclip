...
module Views
  module Scadenzario
    module ReportEstrattoFornitoriFolder
...
#      include Helpers::ODF::Report
      ...
      def ui
        ...
        logger.debug('initializing ReportEstrattoFornitoriFolder...')
        xrc = Xrc.instance()
        ...
        xrc.find('lstrep_estratto', self, :extends => ReportField) do |list|
          ...
          list.data_info([{:attr => :fornitore},
                          ...
                          {:attr => :data, :format => :date,
                            :if => lambda {|content| content.is_a? Date}},
      ...
      def btn_ricerca_click(evt)
        ...
        begin
          Wx::BusyCursor.busy() do
            ...
            self.result_set_lstrep_estratto = ctrl.report_estratto_fornitori()
...
#      def btn_stampa_click(evt)
#        Wx::BusyCursor.busy() do
#          template = Helpers::ScadenzarioHelper::EstrattoFornitoriTemplatePath
#          generate(template)
#        end
#      end
#
...
#        report.add_field :intestazione, ["Report Estratto Fatture Fornitori", (filtro.al.blank? ? '' : "al #{filtro.al.to_s(:italian_date)}")].join(' ')
#      end
#
