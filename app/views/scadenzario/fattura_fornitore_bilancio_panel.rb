...
require 'app/views/scadenzario/pagamenti_fattura_fornitore_bilancio_panel'

module Views
  module Scadenzario
    module FatturaFornitoreBilancioPanel
      ...
      def ui(container=nil)
        ...
        xrc.find('PAGAMENTI_FATTURA_FORNITORE_BILANCIO_PANEL', container,
          :extends => Views::Scadenzario::PagamentiFatturaFornitoreBilancioPanel,
          :force_parent => self,
          :alias => :pagamenti_fattura_fornitore_panel) # importante mantenere l'alias per riutilizzare il modulo incluso
