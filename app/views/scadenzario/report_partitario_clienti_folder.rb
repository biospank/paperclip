...
module Views
  module Scadenzario
    module ReportPartitarioClientiFolder
...
#      include Helpers::ODF::Report
      ...
      def ui
        ...
        logger.debug('initializing ReportPartitarioClientiFolder...')
        xrc = Xrc.instance()
      ...
      def btn_ricerca_click(evt)
        ...
        begin
          Wx::BusyCursor.busy() do
            ...
            self.result_set_lstrep_partitario = ctrl.report_partitario_clienti()
...
#      def btn_stampa_click(evt)
#        Wx::BusyCursor.busy() do
#          template = Helpers::ScadenzarioHelper::PartitarioClientiTemplatePath
#          generate(template)
#        end
#      end
#
...
#        report.add_field :intestazione, ["Report Partitario Fatture Clienti", (filtro.al.blank? ? '' : "al #{filtro.al.to_s(:italian_date)}")].join(' ')
#      end
#
