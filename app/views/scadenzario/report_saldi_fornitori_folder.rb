...
module Views
  module Scadenzario
    module ReportSaldiFornitoriFolder
...
#      include Helpers::ODF::Report
      ...
      def ui
        ...
        logger.debug('initializing ReportSaldiFornitoriFolder...')
        xrc = Xrc.instance()
        ...
        xrc.find('lstrep_saldi', self, :extends => ReportField) do |list|
          list.column_info([{:caption => 'Fornitore', :width => 650},
...
#          Wx::OK | Wx::ICON_INFORMATION, self)
        begin
          Wx::BusyCursor.busy() do
            ...
            self.result_set_lstrep_saldi = ctrl.report_saldi_fornitori()
...
#      def btn_stampa_click(evt)
#        Wx::BusyCursor.busy() do
#          template = Helpers::ScadenzarioHelper::SaldiFornitoriTemplatePath
#          generate(template)
#        end
#      end
#
...
#        report.add_field :intestazione, ["Report Saldi Fatture Fornitori", (filtro.al.blank? ? '' : "al #{filtro.al.to_s(:italian_date)}")].join(' ')
#      end
#
