...
module Views
  module Configurazione
    module ProgressivoDdtPanel
      include Views::Base::Panel
      include Helpers::MVCHelper
      
      def ui

        model :progressivo_ddt => {:attrs => [:anno_rif, :progressivo],
                                               :alias => :progressivo
        }
        ...
        subscribe(:evt_progressivo_ddt) do |data|
      ...
      def chce_anno_rif_select(evt)
        begin
          ...
          if self.progressivo = ctrl.search_progressivo(Models::ProgressivoDdt, anno)
              ...
              if can? :write, Helpers::ApplicationHelper::Modulo::CONFIGURAZIONE
                ...
                if self.progressivo
                  ...
                  if self.progressivo.valid?
                    res = Wx::message_box("Confermi la modifica del progressivo documento di trasporto?",
                      'Domanda',
