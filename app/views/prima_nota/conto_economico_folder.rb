    ...
    module ContoEconomicoFolder
      ...
      def stampa(filtro)
        ...
        Wx::BusyCursor.busy() do
          ...
          generate(:report_conto_economico,
            :margin_top => 50,
            :margin_bottom => 40,
      ...
      def render_header(opts={})
        ...
        begin
          header.write(
            ERB.new(
              IO.read(Helpers::PrimaNotaHelper::BilancioContoEconomicoHeaderTemplatePath)
            ).result(binding)
          )
        rescue Exception => e
          log_error(self, e)
      ...
      def render_footer(opts={})
        begin
          footer.write(
            ERB.new(
              IO.read(Helpers::PrimaNotaHelper::BilancioContoEconomicoFooterTemplatePath)
            ).result(binding)
          )
        rescue Exception => e
          log_error(self, e)
