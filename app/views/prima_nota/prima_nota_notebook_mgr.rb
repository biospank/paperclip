...
require 'app/views/prima_nota/scritture_bilancio_folder'
    ...
    module PrimaNotaNotebookMgr
      ...
      def ui
        ...
        if configatron.bilancio.attivo
          xrc.find('SCRITTURE_FOLDER', self) do |folder|
            # alla rimozione dei folder, quelli presenti vengono rinumerati a partire da zero
            self.delete_page(Helpers::PrimaNotaHelper::WXBRA_SCRITTURE_FOLDER)
          end
          ...
          xrc.find('SCRITTURE_BILANCIO_FOLDER', self,
            :extends => Views::PrimaNota::ScrittureBilancioFolder,
            :alias => :scritture_folder)
          scritture_folder.ui()
          ...
          xrc.find('SCRITTURE_BILANCIO_FOLDER', self) do |folder|
            # alla rimozione dei folder, quelli presenti vengono rinumerati a partire da zero
            self.delete_page(Helpers::PrimaNotaHelper::WXBRA_SCRITTURE_FOLDER + 1)
          end
