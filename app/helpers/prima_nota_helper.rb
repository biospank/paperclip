...
module Helpers
  module PrimaNotaHelper
    ...
    WXBRA_REPORT_STAMPE_BILANCIO_FOLDER = 2
    ...
    StampeBilancioHeaderTemplatePath = 'resources/templates/report/scritture/stampe_bilancio_header.html.erb'
    StampeBilancioBodyTemplatePath = 'resources/templates/report/scritture/stampe_bilancio_body.html.erb'
