class CreateDettaglioFatturePartitaDoppia < ActiveRecord::Migration
  def self.up
    ...
    execute "CREATE INDEX DFPD_FATTURA_CLIENTE_FK_IDX ON dettaglio_fatture_partita_doppia (dettaglio_fattura_cliente_id)"
    execute "CREATE INDEX DFPD_FATTURA_FORNITORE_FK_IDX ON dettaglio_fatture_partita_doppia (dettaglio_fattura_fornitore_id)"
  end
